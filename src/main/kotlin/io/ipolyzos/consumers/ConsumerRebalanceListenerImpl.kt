...
class ConsumerRebalanceListenerImpl(private val consumer: KafkaConsumer<String, String>): ConsumerRebalanceListener {
    ...
    fun addOffsetToTrack(topic: String?, partition: Int, offset: Long) {
        currentOffsets.put(
            ...
            OffsetAndMetadata(offset + 1, null)
        )
    }
